...
public final class Program {
	...
	public static final int TECHNICAL_VERSION = 28;
	...
	public static Release[] getReleases() {
		return new Release[] { 
				Release.create("1.29.0", 2026,  7, 24), 
				Release.create("1.28.0", 2026,  6, 23), 
				Release.create("1.27.0", 2026,  6,  8), 
				Release.create("1.26.0", 2026,  6,  1), 
				Release.create("1.25.0", 2026,  5, 26), 
				Release.create("1.24.0", 2026,  2, 26), 
				Release.create("1.23.0", 2026,  2, 25), 
				Release.create("1.22.0", 2025,  9, 29), 
