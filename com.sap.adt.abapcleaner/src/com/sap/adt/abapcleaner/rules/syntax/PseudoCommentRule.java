...
public class PseudoCommentRule extends RuleForTokens {
   ...
   private final static RuleReference[] references = new RuleReference[] { 
	...
	@Override
	public String getDescription() { return "Replaces obsolete pseudo comments (\"#EC ...) for the Extended Program Check (SLIN) with corresponding pragmas. This requires a NetWeaver version >= 7.0 EhP2. Note that pseudo comments for Code Inspector (\"#EC CI_...) are kept, as they have not been replaced by pragmas yet."; }
