...
public class AlignMethodsForTestingRule extends AlignMethodsWithoutParamsRuleBase {
   private enum Columns  {
	...
	@Override
	public String getDescription() { return "Aligns consecutive METHODS ... FOR TESTING declarations. Activate this rule to override the result of 'Align METHODS declarations' with special settings."; }
