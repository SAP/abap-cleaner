...
public class FinalVariableRule extends RuleForLocalVariables {
	...
	@Override
	public String getDescription() { return "Replaces DATA() inline declarations with FINAL() if no other write access to the respective variable is found. This requires a NetWeaver version >= 7.57."; }
