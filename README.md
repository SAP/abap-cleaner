...
with **one keystroke**. ABAP cleaner then applies **70+ different [cleanup rules](docs/rules.md)** to your code section, 
...
both with a "broadband" approach (simultaneously applying 70+ different rules) 
